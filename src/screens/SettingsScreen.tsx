            ...
            <View style={[getInfoStyles(COLORS).row, isAdmin && getInfoStyles(COLORS).rowBorder]}>
              ...
              {isAdmin && editingTg ? (
                <Switch
                  ...
                  thumbColor={telegramConf.enabled ? COLORS.success : '#f4f3f4'}
...
const getStyles = (COLORS: any) => StyleSheet.create({
  ...
  editLink: { fontSize: 12, fontFamily: 'Inter-SemiBold', color: COLORS.primary },
  cancelLink: { fontSize: 12, fontFamily: 'Inter-Medium', color: COLORS.textMuted },
  saveLink: { fontSize: 12, fontFamily: 'Inter-SemiBold', color: COLORS.primary },
  ...
  avatarLetter: { fontSize: 16, fontFamily: 'Inter-SemiBold', color: COLORS.textSecondary },
  profileInfo: { flex: 1 },
  profileName: { fontSize: 15, fontFamily: 'Inter-SemiBold', color: COLORS.textPrimary },
  profileRole: { fontSize: 12, fontFamily: 'Inter-Regular', color: COLORS.textMuted, marginTop: 2 },
  logoutRow: {
    paddingHorizontal: 18, paddingVertical: 14,
    borderTopWidth: 1, borderTopColor: COLORS.borderLight,
  },
  logoutText: { fontSize: 13, fontFamily: 'Inter-Medium', color: COLORS.error },
...
const getInfoStyles = (COLORS: any) => StyleSheet.create({
  ...
  label: { fontSize: 13, fontFamily: 'Inter-Regular', color: COLORS.textSecondary },
...
const getThrStyles = (COLORS: any) => StyleSheet.create({
  ...
  label: { fontSize: 13, fontFamily: 'Inter-Medium', color: COLORS.textPrimary },
  unit: { fontSize: 11, fontFamily: 'Inter-Regular', color: COLORS.textLight },
  inputRow: { flexDirection: 'row', gap: 12 },
  inputGroup: { flex: 1 },
  inputLabel: { fontSize: 10, fontFamily: 'Inter-Medium', color: COLORS.textLight, letterSpacing: 0.5, marginBottom: 4 },
  input: {
    backgroundColor: COLORS.background, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10,
    fontSize: 14, fontFamily: 'Inter-Medium', color: COLORS.textPrimary, borderWidth: 1, borderColor: COLORS.border,
  },
...
const getFutStyles = (COLORS: any) => StyleSheet.create({
  ...
  rowBorder: { borderBottomWidth: 1, borderBottomColor: COLORS.borderLight },
  dot: { width: 6, height: 6, borderRadius: 3, backgroundColor: COLORS.primaryBorder },
  content: { flex: 1 },
  title: { fontSize: 13, fontFamily: 'Inter-SemiBold', color: COLORS.textPrimary },
  desc: { fontSize: 11, fontFamily: 'Inter-Regular', color: COLORS.textMuted, marginTop: 2 },
  tag: {
    fontSize: 8, fontFamily: 'Outfit-Bold', color: COLORS.textLight,
